...
declare const _default: import("vue").DefineComponent<{
    ...
    options: {
        type: PropType<Omit<SelectionOptions, "boundaries">>;
        default: () => {};
    };
}, {
    instance: SelectionArea | null;
}, unknown, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, Record<string, any>, string, import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, Readonly<{
    options: Omit<SelectionOptions, "boundaries">;
} & {
    onBeforeStart?: Function | undefined;
...
export { _default as default, Quantify, ScrollEvent, ChangedElements, SelectionStore, SelectionEvent, SelectionEvents, AreaLocation, Coordinates, TapMode, OverlapMode, Scrolling, SingleTap, Features, Behaviour, SelectionOptions, PartialSelectionOptions, SelectionArea as VanillaSelectionArea };
